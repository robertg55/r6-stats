...
def setup_logger() -> logging.Logger:
    ...
    This function creates a logger that logs messages to `stdout` with a specific format. It sets the log level 
    to `DEBUG` and ensures that the logger does not add multiple handlers if it has already been set up.
